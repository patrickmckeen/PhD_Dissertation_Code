...
main_sat_rwmtq =  create_GPS_6U_sat(real=True,rand=False,mtm_scale = mtm_scale,use_dipole = dipole_on,use_mtq = True,include_mtmbias = mtm_bias_on, include_mtqbias = mtq_bias_on,include_gbias = gyro_bias_on,include_sbias = sun_bias_on,use_prop = prop_torq_on,use_RW )
...
est_sat_only_gen_rwmtq =  create_GPS_6U_sat(real=False,rand=False,include_sbias = sun_bias_on,estimate_sun_bias = sun_bias_on,  include_mtmbias = mtm_bias_on,estimate_mtm_bias = mtm_bias_on, use_gg = False,use_drag = False, use_SRP = False,use_dipole=False,estimate_dipole = False,use_prop=False,estimate_prop_torq = False,use_gen=True,estimate_gen_torq=True,gen_torq_std =  (2-extra_random)*5e-6, gen_mag_max = 1e-3,mtm_scale = mtm_scale, extra_big_est_randomness = extra_random ,use_mtq = True, include_mtqbias = mtq_bias_on,estimate_mtq_bias = mtq_bias_on )
est_sat_only_gen_rwmtq_eclipse =  create_GPS_6U_sat(real=False,rand=False,include_sbias = sun_bias_on,estimate_sun_bias = sun_bias_on,  include_mtmbias = mtm_bias_on,estimate_mtm_bias = mtm_bias_on, use_gg = False,use_drag = False, use_SRP = False,use_dipole=False,estimate_dipole = False,use_prop=False,estimate_prop_torq = False,use_gen=True,estimate_gen_torq=True,gen_torq_std =  (2-extra_random)*5e-6, gen_mag_max = 1e-3,mtm_scale = mtm_scale, extra_big_est_randomness = extra_random ,use_mtq = True, include_mtqbias = mtq_bias_on,estimate_mtq_bias = mtq_bias_on,care_about_eclipse = True )
...
case_quat_RWMTQ_all_al1kap0 = ["thesis_6U_quat_RWMTQ_est_w_all_al1kap0",           est_sat_w_all_rwmtq,     main_sat_rwmtq,    1,  w0,      q0,h0,      cov0_estimate_all_rwmtq,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,all_int_cov_rwmtq,3*(mtm_bias_on+gyro_bias_on+sun_bias_on),3*(prop_torq_on+dipole_on),3*mtq_bias_on, 1.0]
case_quat_RWMTQ_all_al01kap0 = ["thesis_6U_quat_RWMTQ_est_w_all_al01kap0",           est_sat_w_all_rwmtq,     main_sat_rwmtq,    1,  w0,      q0,h0,      cov0_estimate_all_rwmtq,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,all_int_cov_rwmtq,3*(mtm_bias_on+gyro_bias_on+sun_bias_on),3*(prop_torq_on+dipole_on),3*mtq_bias_on, 1e-1]
case_quat_RWMTQ_all_al001kap0 = ["thesis_6U_quat_RWMTQ_est_w_all_al001kap0",           est_sat_w_all_rwmtq,     main_sat_rwmtq,    1,  w0,      q0,h0,      cov0_estimate_all_rwmtq,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,all_int_cov_rwmtq,3*(mtm_bias_on+gyro_bias_on+sun_bias_on),3*(prop_torq_on+dipole_on),3*mtq_bias_on, 1e-2]
case_quat_RWMTQ_all_al1kap3mL = ["thesis_6U_quat_RWMTQ_est_w_all_al1kap3mL",           est_sat_w_all_rwmtq,     main_sat_rwmtq,    1,  w0,      q0,h0,      cov0_estimate_all_rwmtq,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,all_int_cov_rwmtq,3*(mtm_bias_on+gyro_bias_on+sun_bias_on),3*(prop_torq_on+dipole_on),3*mtq_bias_on, 1.0,None]

case_quat_RWMTQ_all_1est0other = ["thesis_6U_quat_RWMTQ_est_w_all_1est0other",           est_sat_w_all_rwmtq,     main_sat_rwmtq,    1,  w0,      q0,h0,      cov0_estimate_all_rwmtq,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,all_int_cov_rwmtq,3*(mtm_bias_on+gyro_bias_on+sun_bias_on),3*(prop_torq_on+dipole_on),3*mtq_bias_on,1e-3,0,"",1.0,0.0]
case_quat_RWMTQ_all_01est0other = ["thesis_6U_quat_RWMTQ_est_w_all_01est0other",           est_sat_w_all_rwmtq,     main_sat_rwmtq,    1,  w0,      q0,h0,      cov0_estimate_all_rwmtq,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,all_int_cov_rwmtq,3*(mtm_bias_on+gyro_bias_on+sun_bias_on),3*(prop_torq_on+dipole_on),3*mtq_bias_on,1e-3,0,"",1e-1,0.0]
case_quat_RWMTQ_all_001est0other = ["thesis_6U_quat_RWMTQ_est_w_all_001est0other",           est_sat_w_all_rwmtq,     main_sat_rwmtq,    1,  w0,      q0,h0,      cov0_estimate_all_rwmtq,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,all_int_cov_rwmtq,3*(mtm_bias_on+gyro_bias_on+sun_bias_on),3*(prop_torq_on+dipole_on),3*mtq_bias_on,1e-3,0,"",1e-2,0.0]
case_quat_RWMTQ_all_001est1other = ["thesis_6U_quat_RWMTQ_est_w_all_001est1other",           est_sat_w_all_rwmtq,     main_sat_rwmtq,    1,  w0,      q0,h0,      cov0_estimate_all_rwmtq,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,all_int_cov_rwmtq,3*(mtm_bias_on+gyro_bias_on+sun_bias_on),3*(prop_torq_on+dipole_on),3*mtq_bias_on,1e-3,0,"",1e-2,1.0]
case_quat_RWMTQ_all_1est1other = ["thesis_6U_quat_RWMTQ_est_w_all_1est1other",           est_sat_w_all_rwmtq,     main_sat_rwmtq,    1,  w0,      q0,h0,      cov0_estimate_all_rwmtq,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,all_int_cov_rwmtq,3*(mtm_bias_on+gyro_bias_on+sun_bias_on),3*(prop_torq_on+dipole_on),3*mtq_bias_on,1e-3,0,"",1.0,1.0]
case_quat_RWMTQ_all_nodipole_1est_01other = ["thesis_6U_quat_RWMTQ_est_w_all_nodipole_1est_01other",           est_sat_w_all_rwmtq_nodipole,     main_sat_rwmtq_nodipole,    1,  w0,      q0,h0,      cov0_estimate_all_rwmtq_nodipole,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,all_int_cov_rwmtq,3*(mtm_bias_on+gyro_bias_on+sun_bias_on),3*(prop_torq_on),3*mtq_bias_on,1e-3,0,"",1.0,0.1]
case_quat_RWMTQ_all_nodipole_1est_001other = ["thesis_6U_quat_RWMTQ_est_w_all_nodipole_1est_001other",           est_sat_w_all_rwmtq_nodipole,     main_sat_rwmtq_nodipole,    1,  w0,      q0,h0,      cov0_estimate_all_rwmtq_nodipole,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,all_int_cov_rwmtq,3*(mtm_bias_on+gyro_bias_on+sun_bias_on),3*(prop_torq_on),3*mtq_bias_on,1e-3,0,"",1.0,0.01]
case_quat_RWMTQ_all_nodipole_01est_01other = ["thesis_6U_quat_RWMTQ_est_w_all_nodipole_01est_01other",           est_sat_w_all_rwmtq_nodipole,     main_sat_rwmtq_nodipole,    1,  w0,      q0,h0,      cov0_estimate_all_rwmtq_nodipole,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,all_int_cov_rwmtq,3*(mtm_bias_on+gyro_bias_on+sun_bias_on),3*(prop_torq_on),3*mtq_bias_on,1e-3,0,"",0.1,0.1]
case_quat_RWMTQ_all_nodipole_001est_001other = ["thesis_6U_quat_RWMTQ_est_w_all_nodipole_001est_001other",           est_sat_w_all_rwmtq_nodipole,     main_sat_rwmtq_nodipole,    1,  w0,      q0,h0,      cov0_estimate_all_rwmtq_nodipole,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,all_int_cov_rwmtq,3*(mtm_bias_on+gyro_bias_on+sun_bias_on),3*(prop_torq_on),3*mtq_bias_on,1e-3,0,"",0.01,0.01]

case_quat_RWMTQ_all_nodipole_0est_1other = ["thesis_6U_quat_RWMTQ_est_w_all_nodipole_0est_1other",           est_sat_w_all_rwmtq_nodipole,     main_sat_rwmtq_nodipole,    1,  w0,      q0,h0,      cov0_estimate_all_rwmtq_nodipole,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,all_int_cov_rwmtq,3*(mtm_bias_on+gyro_bias_on+sun_bias_on),3*(prop_torq_on),3*mtq_bias_on,1e-3,0,"",0.0,1.0]
case_quat_RWMTQ_all_nodipole_0est_01other = ["thesis_6U_quat_RWMTQ_est_w_all_nodipole_0est_01other",           est_sat_w_all_rwmtq_nodipole,     main_sat_rwmtq_nodipole,    1,  w0,      q0,h0,      cov0_estimate_all_rwmtq_nodipole,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,all_int_cov_rwmtq,3*(mtm_bias_on+gyro_bias_on+sun_bias_on),3*(prop_torq_on),3*mtq_bias_on,1e-3,0,"",0.0,0.1]
case_quat_RWMTQ_all_nodipole_0est_001other = ["thesis_6U_quat_RWMTQ_est_w_all_nodipole_0est_001other",           est_sat_w_all_rwmtq_nodipole,     main_sat_rwmtq_nodipole,    1,  w0,      q0,h0,      cov0_estimate_all_rwmtq_nodipole,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,all_int_cov_rwmtq,3*(mtm_bias_on+gyro_bias_on+sun_bias_on),3*(prop_torq_on),3*mtq_bias_on,1e-3,0,"",0.0,0.01]

case_quat_RWMTQ_all_nodipole_1est_01other_nobigrand = ["thesis_6U_quat_RWMTQ_est_w_all_nodipole_1est_01other_nobigrand",           est_sat_w_all_rwmtq_no_extra_random_nodipole,     main_sat_rwmtq_nodipole,    1,  w0,      q0,h0,      cov0_estimate_all_rwmtq_nodipole,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,all_int_cov_rwmtq,3*(mtm_bias_on+gyro_bias_on+sun_bias_on),3*(prop_torq_on),3*mtq_bias_on,1e-3,0,"",1.0,0.1]
case_quat_RWMTQ_all_nodipole_1est_001other_nobigrand = ["thesis_6U_quat_RWMTQ_est_w_all_nodipole_1est_001other_nobigrand",           est_sat_w_all_rwmtq_no_extra_random_nodipole,     main_sat_rwmtq_nodipole,    1,  w0,      q0,h0,      cov0_estimate_all_rwmtq_nodipole,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,all_int_cov_rwmtq,3*(mtm_bias_on+gyro_bias_on+sun_bias_on),3*(prop_torq_on),3*mtq_bias_on,1e-3,0,"",1.0,0.01]
case_quat_RWMTQ_all_nodipole_01est_01other_nobigrand = ["thesis_6U_quat_RWMTQ_est_w_all_nodipole_01est_01other_nobigrand",           est_sat_w_all_rwmtq_no_extra_random_nodipole,     main_sat_rwmtq_nodipole,    1,  w0,      q0,h0,      cov0_estimate_all_rwmtq_nodipole,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,all_int_cov_rwmtq,3*(mtm_bias_on+gyro_bias_on+sun_bias_on),3*(prop_torq_on),3*mtq_bias_on,1e-3,0,"",0.1,0.1]
case_quat_RWMTQ_all_nodipole_001est_001other_nobigrand = ["thesis_6U_quat_RWMTQ_est_w_all_nodipole_001est_001other_nobigrand",           est_sat_w_all_rwmtq_no_extra_random_nodipole,     main_sat_rwmtq_nodipole,    1,  w0,      q0,h0,      cov0_estimate_all_rwmtq_nodipole,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,all_int_cov_rwmtq,3*(mtm_bias_on+gyro_bias_on+sun_bias_on),3*(prop_torq_on),3*mtq_bias_on,1e-3,0,"",0.01,0.01]
...
case_quat_RWMTQ_simple = ["thesis_6U_quat_RWMTQ_est_simple",        est_sat_simple_rwmtq,    main_sat_rwmtq,    1,  w0,      q0,h0,      cov0_estimate_simple_rwmtq,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,simple_int_cov_rwmtq,3,0,0,1e-3,0,"",0.0,1.0,w0,q0,h0]
# case_quat_RWMTQ_gen = ["thesis_6U_quat_RWMTQ_est_w_gen",           est_sat_gen,       main_sat_rwmtq, 1,  w0,      q0,h0,      cov0_estimate_gen,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,gen_int_cov,9,6]
case_quat_RWMTQ_bias = ["thesis_6U_quat_RWMTQ_est_bias",           est_sat_biases_only_rwmtq,     main_sat_rwmtq,    1,  w0,      q0,h0,      cov0_estimate_biases_only_rwmtq,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,biases_int_cov_rwmtq,9,0,0,1e-3,0,"",0.0,1.0,w0,q0,h0]
case_quat_RWMTQ_dist = ["thesis_6U_quat_RWMTQ_est_dist",           est_sat_dist_only_rwmtq,     main_sat_rwmtq,    1,  w0,      q0,h0,      cov0_estimate_dist_only_rwmtq,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,dist_int_cov_rwmtq,3,6,0,1e-3,0,"",0.0,1.0,w0,q0,h0]
# case_quat_RWMTQ_nodipole = ["thesis_6U_quat_RWMTQ_est_nodipole",           est_sat_nodipole_rwmtq,     main_sat_rwmtq,    1,  w0,      q0,h0,      cov0_estimate_nodipole_rwmtq,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,dist_int_cov,9,3,0]
...
# case_quat_RWMTQ_nothing = ["thesis_6U_quat_RWMTQ_est_w_nothing",       est_sat_nothing,   main_sat_rwmtq,   1,  w0,      q0,h0,      cov0_estimate_nothing,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,nothing_int_cov,0,0]
case_quat_RWMTQ_simple_initial_off = ["thesis_6U_quat_RWMTQ_est_simple_initial_off",        est_sat_simple_rwmtq,    main_sat_rwmtq,    1,   w0,q0,h0,      cov0_estimate_simple_initial_off_rwmtq,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,simple_int_cov_rwmtq,3,0,0,1e-3,0,"",0.0,1.0,0*w0,unitvecs4[0],0*h0]
# case_quat_RWMTQ_gen = ["thesis_6U_quat_RWMTQ_est_w_gen",           est_sat_gen,       main_sat_rwmtq, 1,  w0,      q0,h0,      cov0_estimate_gen,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,gen_int_cov,9,6]
case_quat_RWMTQ_bias_initial_off = ["thesis_6U_quat_RWMTQ_est_bias_initial_off",           est_sat_biases_only_rwmtq,     main_sat_rwmtq,    1,   w0,q0,h0,      cov0_estimate_biases_only_initial_off_rwmtq,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,biases_int_cov_rwmtq,9,0,0,1e-3,0,"",0.0,1.0,0*w0,unitvecs4[0],0*h0]
case_quat_RWMTQ_dist_initial_off = ["thesis_6U_quat_RWMTQ_est_dist_initial_off",           est_sat_dist_only_rwmtq,     main_sat_rwmtq,    1,   w0,q0,h0,      cov0_estimate_dist_only_initial_off_rwmtq,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,dist_int_cov_rwmtq,3,6,0,1e-3,0,"",0.0,1.0,0*w0,unitvecs4[0],0*h0]
# case_quat_RWMTQ_nodipole_initial_off = ["thesis_6U_quat_RWMTQ_est_nodipole_initial_off",           est_sat_nodipole_rwmtq,     main_sat_rwmtq,    1,   w0,q0,h0,      cov0_estimate_nodipole,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,dist_int_cov,9,3]
...
case_quat_RWMTQ_simple_eclipse = ["thesis_6U_quat_RWMTQ_est_simple_eclipse",        est_sat_simple_rwmtq_eclipse,    main_sat_rwmtq_eclipse,    1,  w0,      q0,h0,      cov0_estimate_simple_rwmtq,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,simple_int_cov_rwmtq,3,0,0,1e-3,0,"",0.0,1.0,w0,q0,h0,True]
case_quat_RWMTQ_bias_eclipse = ["thesis_6U_quat_RWMTQ_est_bias_eclipse",           est_sat_biases_only_rwmtq_eclipse,     main_sat_rwmtq_eclipse,    1,  w0,      q0,h0,      cov0_estimate_biases_only_rwmtq,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,biases_int_cov_rwmtq,9,0,0,1e-3,0,"",0.0,1.0,w0,q0,h0,True]
case_quat_RWMTQ_dist_eclipse = ["thesis_6U_quat_RWMTQ_est_dist_eclipse",           est_sat_dist_only_rwmtq_eclipse,     main_sat_rwmtq_eclipse,    1,  w0,      q0,h0,      cov0_estimate_dist_only_rwmtq,      True,  quat_rwmtq_goals, prop_schedule,      4500,    orb_file,dist_int_cov_rwmtq,3,6,0,1e-3,0,"",0.0,1.0,w0,q0,h0,True]
...
tests = [case_quat_RWMTQ_all_eclipse]
for j in tests:
    run_sim_wrapper(*j)
